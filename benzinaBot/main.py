...
lastUpdateId = None
# tastiere predefinite per le scelte dell'utente
keyboardRiempimento = [[{"text": "1/4"}], [{"text": "2/4"}], [{"text": "3/4"}], [{"text": "4/4"}]]
keyboardTipocarburante = [['Benzina'], ['Diesel'], ['Metano'], ['GPL']];
            ...
            if 'text' in updates[-1]['message']:
                ...
                if text == '/start':
                    ...
                    if mysql.checkUser(user_id) == False:
                        ...
                        bot.sendKeyboard(chat_id, "Qual'è il tipo di carburante che utilizzi?", keyboardTipocarburante)
                        while(bot.checkForNewMessages(lastUpdateId) == False):
                            pass
                        updates = bot.getUpdates(lastUpdateId)
                        # tipo di carburante
                        ...
                        mysql.insert(f"INSERT INTO utenti (idUtente, capacitaSerbatoio, tipoCarburante, kmLitro, maxRange) VALUES ({user_id}, {capeienza}, '{tipoCarburante}', {kmLitro}, {range})")
                    ...
                    bot.sendKeyboard(chat_id, "Quanto carburante devi rifornire?", keyboardRiempimento)
